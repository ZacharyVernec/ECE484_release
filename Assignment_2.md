...
Evaluate your implementation on a reasonable amount of input states, enough to show that your gate works as expected, i.e., show that the final state is the expected output state after applying $CX$ between Alice and Bob's qubits directly.
